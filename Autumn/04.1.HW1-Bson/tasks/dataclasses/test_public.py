...
def test_marshal_keep_dc_typeinfo_double_inside_empty() -> None:
    @dataclass
    class C:
        pass
...
def compare_classes(exp: Any, real: Any) -> None:
    assert exp.__name__ == real.__name__
    assert exp.__annotations__ == real.__annotations__
    assert len(exp.__dataclass_fields__) == len(real.__dataclass_fields__)
    assert exp.__dataclass_fields__.keys() == real.__dataclass_fields__.keys()


def test_unmarshal_keep_dc_typeinfo_double_inside_empty() -> None:
    @dataclass
    class C:
        pass
    ...
    assert result["a"].__class__ is dict

    compare_classes(C, result["a"]["b"].__class__)
    assert result["a"]["b"].__class__ is not dict
    # assert result['a']['b'].__class__.__dataclass_params__ == C.__dataclass_params__


def test_marshal_keep_dc_typeinfo_single_inside_empty() -> None:
    @dataclass
    class C:
        pass
...
def test_unmarshal_keep_dc_typeinfo_single_inside_empty() -> None:
    @dataclass
    class C:
        pass
    ...
    assert result.__class__ is dict
    assert result["a"].__class__ is not dict

    compare_classes(C, result["a"].__class__)
    # assert result['a'].__class__.__dataclass_params__ == C.__dataclass_params__


def test_marshal_keep_dc_typeinfo_outside_empty() -> None:
    @dataclass
    class C:
        pass
...
def test_unmarshal_keep_dc_typeinfo_outside_empty() -> None:
    @dataclass
    class C:
        pass
    ...
    result = m.unmarshal(inp)

    assert result.__class__ is not dict

    compare_classes(C, result.__class__)
    # assert result.__class__.__dataclass_params__ == C.__dataclass_params__


def test_bidi_keep_dc_typeinfo_two_instances_double_inside_empty() -> None:
    @dataclass
    class C:
        pass
    ...
    compare_classes(C, v2["a"]["b1"].__class__)
    compare_classes(C, v2["a"]["b2"].__class__)
    assert v2["a"]["b1"].__class__ is v2["a"]["b2"].__class__


def test_bidi_keep_dc_typeinfo_two_instances_inside_empty() -> None:
    @dataclass
    class C:
        pass
    ...
    compare_classes(C, v2["b1"].__class__)
    compare_classes(C, v2["b2"].__class__)
    assert v2["b1"].__class__ is v2["b2"].__class__


def test_bidi_keep_dc_typeinfo_just_name_doesnt_matter() -> None:
    @dataclass
    class C:
        pass
    ...
    compare_classes(C2, v2["b1"].__class__)
    compare_classes(C2, v2["b2"].__class__)
    compare_classes(C, v2["b3"].__class__)
    assert v2["b1"].__class__ is v2["b2"].__class__
    assert v2["b1"].__class__ is not v2["b3"].__class__


def test_bidi_dc_with_single_field() -> None:
    @dataclass
    class C:
        v: str

    v = {"a": {"b1": C(123), "b2": C(None)}}  # type: ignore
    m = bson.Mapper(keep_types=True)
    v2 = m.unmarshal(m.marshal(v))
...
def test_bidi_dc_with_several_values() -> None:
    @dataclass
    class C:
        v1: str
        v2: str = "hello"

    v = {"a": {"b1": C(12.3), "b2": C("abc", "cde")}}  # type: ignore
    m = bson.Mapper(keep_types=True)
    v2 = m.unmarshal(m.marshal(v))
...
def test_bidi_dc_with_several_values_inverted_order() -> None:
    @dataclass
    class C:
        v2: Any
        v1: Any

    v = {"a": {"b1": C(12.3, None), "b2": C("abc", "cde")}}
    m = bson.Mapper(keep_types=True)
    v2 = m.unmarshal(m.marshal(v))
    ...
    compare_classes(C, v2["a"]["b2"].__class__)
    assert v2["a"]["b1"].__class__ is v2["a"]["b2"].__class__
    assert v2["a"]["b1"].v1 == v["a"]["b1"].v1
    assert v2["a"]["b2"].v1 == v["a"]["b2"].v1
    assert v2["a"]["b1"].v2 == v["a"]["b1"].v2
    assert v2["a"]["b2"].v2 == v["a"]["b2"].v2
